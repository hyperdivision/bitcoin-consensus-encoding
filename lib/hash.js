...
var buf1 = Buffer.alloc(50)
const test = '1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef'
console.log(encode(test, buf1, 14))
console.log(decode(buf1, 14, 32))